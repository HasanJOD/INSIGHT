    ...
    <div className="sticky top-24 flex flex-col gap-1">
      ...
      {topics.map((topic) => (
        <div
          ...
          className={`flex items-center gap-3 p-2 rounded cursor-pointer transition-all border-l-2 border-transparent ${
            theme === "dark"
      ...
      {/* Footer */}
      <div
        className={`mt-8 border-t pt-4 px-2 ${
      ...
      >
        ...
        >
          <p className="text-[10px] text-slate-500 italic">
            Codevirus v3.1.0-secure. System status: Nominal.
          </p>
        </div>
      </div>
    </div>
